"""
Django settings for farmersmanagement project.
...
SECRET_KEY = 'django-insecure-528^10!)c+1m53unc29u125-&ng7=si*3y2kq1l645&4p@^=-3'
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize',  # For humanizing template filters
    'farmers',
]
...
MIDDLEWARE = [
    ...
    'farmers.middleware.AdminAuthMiddleware',
]
...
WSGI_APPLICATION = 'farmersmanagement.wsgi.application'
...
os.makedirs(os.path.join(MEDIA_ROOT, 'farmers'), exist_ok=True)
